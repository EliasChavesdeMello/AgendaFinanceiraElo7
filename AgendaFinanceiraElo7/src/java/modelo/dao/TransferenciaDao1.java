...
public class TransferenciaDao1 implements Serializable{

    public List<Transferencia> transferencias;
    public volatile PersistenceStrategy strategy;
    public List listPersistence;

    public TransferenciaDao1(String dirParaPersistir) {
        this.transferencias = new ArrayList<Transferencia>();
        strategy = new FilePersistenceStrategy(new File(dirParaPersistir));
